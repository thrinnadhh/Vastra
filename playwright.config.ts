...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command:
        'test -f packages/api-client/dist/index.js || pnpm --filter @vastra/api-client build; pnpm --filter @vastra/admin-dashboard exec next build && pnpm --filter @vastra/admin-dashboard exec next start -H 127.0.0.1 -p 4179',
