...
Normal repository CI is the mandatory merge gate for processing order, stale events, inventory release, retry authorization and production build compatibility.
