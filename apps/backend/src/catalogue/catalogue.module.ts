...
import { SupabaseCustomerCheckoutQuoteGateway } from './customer-checkout-quote.gateway';
...
@Module({
  controllers: [
    ...
    CustomerCheckoutQuoteController,
  ...
  providers: [
    ...
    },
    {
      ...
      useClass: SupabaseCustomerCheckoutQuoteGateway,
    },
    {
  ...
  exports: [
    ...
    CUSTOMER_CHECKOUT_QUOTE_GATEWAY,
